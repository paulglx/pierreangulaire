...
- The segmentation atlas tiles a fixed 8 × 8 slots per layer and grows in depth only, so it holds at most `64 × ⌊maxTextureDimension3D / brickSize⌋` painted bricks.
